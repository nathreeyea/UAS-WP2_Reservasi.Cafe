...
-- membuang struktur untuk table sisfohotel.ruang
...
-- Membuang data untuk tabel sisfohotel.ruang: ~5 rows (lebih kurang)
/*!40000 ALTER TABLE `kamar` DISABLE KEYS */;
INSERT INTO `kamar` (`idruang`, `tipe`, `jumlah`, `harga`, `gambar`) VALUES
...
INSERT INTO `pemesanan` (`idpesan`, `tglpesan`, `batasbayar`, `idruang`, `tipe`, `harga`, `jumlah`, `idtamu`, `nama`, `alamat`, `telepon`, `tglmasuk`, `tglkeluar`, `lamahari`, `totalbayar`, `status`) VALUES
