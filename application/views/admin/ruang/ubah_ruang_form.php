<main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
        <div class="card">
            ...
            <form class="text-center" method="post" action="<?=site_url()?>admin/ubah_ruang_save" enctype="multipart/form-data">

                <input type="hidden" class="form-control" id="idruang" name="idruang" value="<?=$ruang->idruang?>">
                <div class="form-group row">
                    <label for="tipe" class="col-sm-4 col-form-label">Tipe</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="tipe" name="tipe" placeholder="Tipe" value="<?=$ruang->tipe?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="number" class="form-control" id="harga" name="harga" placeholder="Harga" value="<?=$ruang->harga?>" required>
                    </div>
                </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="bukti">Upload Gambar Ruang</span>
                    </div>
