...
<main class="pt-5 mx-lg-5">
  <div class="container-fluid mt-5">
    ...
    <div class="row">
      <a href="<?=site_url()?>admin/tambah_ruang_form" class="btn btn-info"><i class="fas fa-plus"></i>Tambah Data Ruang</a>
      <table class="table" id="myTable">
        <caption style="caption-side: top; padding:0;">
          ...
          <div class="md-form col-sm-4">
              ...
              <label for="form1">Cari Ruang</label>
          </div>
        </caption>
        <thead>
          <tr>
        ...
        ?>
          <tr>
            <th scope="row">
            <a class="text-info" href="<?=site_url()?>admin/ubah_ruang_form/<?=$ruang->idruang?>"><i class="fas fa-edit"></i>Ubah</a> | 
            <a href="#" class="open-modal text-info" data-toggle="modal" data-target="#modalView" data-tipe="<?=$ruang->tipe?>" data-jumlah="<?=$ruang->jumlah?>" data-harga="<?=$ruang->harga?>" data-gambar="<?=site_url()?>uploads/admin/ruang/<?=$ruang->gambar?>"><i class="fas fa-search"></i>Lihat</a> | 
            <a class="text-info" href="<?=site_url()?>admin/hapus_ruang/<?=$ruang->idruang?>" OnClick="return confirm('Apa anda yakin ingin mendelete ini?');"><i class="fas fa-trash"></i>Hapus</a></th>
            <th scope="row"><?=$no?></th>
            <td><?=$ruang->tipe?></td>
            <td><?=$ruang->jumlah?></td>
            <td><?=$ruang->harga?></td>
