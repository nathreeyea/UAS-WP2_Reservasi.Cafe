    ...
    <div class="container-fluid mt-5">
        <div class="card">
            ...
            <div class="card-body px-lg-5 mt-4 pt-0">
                ...
                if(isset($pemesanan)){
                    $pemesanan = $pemesanan->row();
                ?>
                    <!-- Default form contact -->
                    <form class="text-center" method="post" action="<?=site_url()?>Tamu_ruang/pembayaran_save" enctype="multipart/form-data">
                        
                        <input type="hidden" class="form-control" id="idpesan" name="idpesan" placeholder="Id Ruang" value="<?=$this->uri->segment(3)?>">
                        <div class="form-group row">
                            <label for="nama" class="col-sm-4 col-form-label">Nama Lengkap</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="<?=$pemesanan->nama?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="jumlah" class="col-sm-4 col-form-label">Jumlah Pembayaran</label>
                            <div class="col-sm-8">
                            <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Pembayaran" value="<?=$pemesanan->jumlah?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
